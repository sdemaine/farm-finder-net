...
interface VisitorInterestsData {
  name: string;
  value: number;
}
...
const Dashboard = () => {
  ...
  const profileViewsData: ProfileViewsData[] = [
  ...
  const visitorLocationData: VisitorLocationData[] = [
  ...
  const productSearchData: ProductSearchData[] = [
  ...
  const visitorInterestsData: VisitorInterestsData[] = [
